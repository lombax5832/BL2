...
public class EntityGrenade extends EntityThrowable {
        ...
        if (mop.entityHit != null) {
            ...
            if (mop.entityHit instanceof EntityLiving) {
                ...
                if (sticky) {
                    ...
                    BL2Core.nethandler.sendGrenadePacket(worldObj, this,
                            "parent", stuckTo);
                    ...
                    worldObj.newExplosion(this, posX, posY, posZ, 2.0F, false,
                            false);
                    if (hackySack) {
    ...
    public void onUpdate() {
        if (!sent && !FMLCommonHandler.instance().getEffectiveSide().isClient()) {
            sent = true;
            if (homing || hackySack) {
                BL2Core.nethandler.sendGrenadePacket(worldObj, this, "homing",
                        true);
            }
        }
        if (sticky) {
            ...
            if (stuckTo == null) {
                ...
                setPosition(stuckTo.posX - difX, stuckTo.posY - difY,
                        stuckTo.posZ - difZ);
                timeTilBoom--;
                if (timeTilBoom < 0) {
                    worldObj.newExplosion(this, posX, posY, posZ, 2.0F, false,
        ...
        if (hackySack) {
            ...
            for (Entity e : list) {
                if (e != getThrower() && e instanceof EntityLiving
                        && !(e instanceof EntityPlayer) && e != stuckTo) {
            ...
            if (current != null) {
                ...
                // System.out.println("Current: " + current.getEntityName() +
                // " X:" + x + " Y:" + y + " X:" + x);
