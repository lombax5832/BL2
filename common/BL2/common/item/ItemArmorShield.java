...
public class ItemArmorShield extends ItemArmor implements ISpecialArmor,
    ...
    public static final String[] Companies = new String[] { "", "Tediore",
            "Pangolin", "Dahl", "Vladof", "Hyperion" };
        ...
        if (atr.hitTicker > 0 || atr.charging == true) {
            ...
            for (o = 0; o < 4; o++) {
                if (ep.getCurrentArmor(o) == it) {
                    ...
                    BL2Core.nethandler.sendParticlePacket(ep.worldObj,
                            distance, playerID, it.getItemDamage(), o, true);
                    spawningSent++;
                }

            }
        } else if (spawningSent > 0) {
            BL2Core.nethandler.sendParticlePacket(ep.worldObj, distance,
                    playerID, it.getItemDamage(), o, false);
            spawningSent = 0;
        }
