...
public class BlockRefinedEridiumFlowing extends BlockFluid implements ILiquid {

	int numAdjacentSources = 0;
	boolean isOptimalFlowDirection[] = new boolean[4];
	int flowCost[] = new int[4];

	public BlockRefinedEridiumFlowing(int i) {
	...
	public int stillLiquidId() {
		return BL2Core.refinedEridiumStill.blockID;
	}
