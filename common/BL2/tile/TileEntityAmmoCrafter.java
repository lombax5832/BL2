...
public class TileEntityAmmoCrafter extends BL2Inventory implements ISidedInventory{
    ...
    public void setInventorySlotContents(int slot, ItemStack itemstack)
    {
        ...
        if (slot == 0 && itemstack != null && itemstack.getItem() == new ItemStack(Item.ingotIron).getItem())
        {
            setInventorySlotContents(1, AmmoOutputs.ammoOutputs[0]);
        }
    }
